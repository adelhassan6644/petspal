...
import '../../cart/model/receipt_details_model.dart';
  ...
  Future<void> onClick(Click event, Emitter<AppState> emit) async {
    try {
      ...
      Either<ServerFailure, Response> response =
          await repo.applyCoupon(couponTEC.text.trim());
      response.fold((fail) {
        ...
        if (success.data["data"] != null) {
          ReceiptDetailsModel model =
              ReceiptDetailsModel.fromJson(success.data["data"]);
