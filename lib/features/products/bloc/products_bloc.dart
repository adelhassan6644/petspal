...
import 'package:zurex/features/products/repo/products_repo.dart';
...
class ProductsBloc extends HydratedBloc<AppEvent, AppState> {
  final ProductsRepo repo;
  final InternetConnection internetConnection;

  ProductsBloc({required this.repo, required this.internetConnection})
      : super(Start()) {
    ...
    if (await internetConnection.updateConnectivityStatus()) {
      try {
        ...
        Either<ServerFailure, Response> response =
            await repo.getProducts(_engine);
